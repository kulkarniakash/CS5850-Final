 ...
 * Most of the following code was written by Zejun Li from Akash's previous team (wecook)
 */
...
public:
	...
	*/
	 ...
	 * @param[in]
     @return boolean to determine of the Resource Manager has the Resource we are looking for.
	*/
     ...
     * @return boolean to determine if the Resource Manager has a language type
     */
	...
	@param[in] fontSize this is the default font size for the font to be loaded
     @return int that represents the validation of adding a resource
	*/
	 ...
	 * @param[in] flag the flag set to window, refer to SDL official documentation
     @return int that represents the validation of adding a window
    ...
    @return int that represents the validation of adding a renderer
	 */
	 ...
	 * @param[in] surface sdl surface that will be used to create texture
     @return int that represents the validation of adding a texture
	 */
	 ...
	 * @param[in] rendererSpecifier the id of a renderer stored in resource manager
     @return int that represents the validation of adding a jpg image
	 */ 
	 ...
	 * @param[in] needReload set to true if reload of a language is needed
     @return int that represents the validation of adding a language
	*/
	...
	@param[in] filePath the id of the sound effect to be retrieved
     @return Mix_Chunk pointer that retrieves a Sound Effect
	*/
	 ...
	 * @param[in] filePath the id of the background music to be retrieved
     @return Mix_Music pointer that retrieves our Background Music
	*/
	...
	@param[in] filePath the id of the font to be retrieved
     @return TTF_Font pointer that retrieves our font
	*/
	 ...
	 * @param[in] speicifer the id of the sdl window to be retrieved
     @return SDL_Window pointer that gets our window
	 */ 
	 ...
	 * @param[in] specifier the id of the sdl renderer to be retrieved
     @return SDL_Renderer pointer that gets our renderer
	 */ 
	 ...
	 * @param[in] specifier the id of the sdl texture to be retrieved
     @return SDL_texture pointer that gets our texture
	 */ 
