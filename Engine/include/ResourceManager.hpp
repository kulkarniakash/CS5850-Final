...
private:
	...
	//! maps anguage types to a map that maps string token to the specific language specified by the key
...
public:
	//! @brief returns the only instance of this class, if it doesn't exist yet, it will create the instance first
	 ...
	 * @param[in] filePath the file path of the resource to check
    @param[in] type: the type of this resource we want to check
     */
